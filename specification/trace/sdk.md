...
following cases:
  * No parent (root span).
  * Remote parent (`SpanContext.IsRemote() == true`) with `SampledFlag == true`
  * Remote parent (`SpanContext.IsRemote() == true`) with `SampledFlag == false`
  * Local parent (`SpanContext.IsRemote() == false`) with `SampledFlag == true`
  * Local parent (`SpanContext.IsRemote() == false`) with `SampledFlag == false`
