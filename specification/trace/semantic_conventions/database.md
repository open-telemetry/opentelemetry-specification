...
| `db.statement` | string | The database statement being executed. [2] | `SELECT * FROM wuser_table`; `SET mykey "WuValue"` | Optional |
...
**[2]:** Not collected by default; can be enabled via instrumentation configuration. This attribute may contain private or sensitive information. The instrumentation library should support accepting a function that will sanitize said information before logging it.
