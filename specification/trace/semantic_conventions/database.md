...
**[3]:** The user-agent value is generated by SDK which is a combination of the following. 1. sdk_version : Current version of SDK
   Example : 'cosmos-netstandard-sdk/3.23.0'
2. direct_pkg_version : Direct package version used by Cosmos DB SDK 
   Example : '3.23.1'
3. number_of_client_instances : Number of Cosmos Client instances created by the application
   Example : '1'
4. type_of_machine_architecture : Machine Architecture
   Example : 'X64'
5. operating_system : Operating System
   Example : 'Linux 5.4.0-1098-azure 104 18'
6. runtime_framework : Runtime Framework
   Example : '.NET Core 3.1.32'
7. failover_information : Generated key that added to the user agent to make it possible to determine if the SDK has region failover enabled. Format Reg-{D (Disabled discovery)}-S(application region)|L(List of preferred regions)|N(None, user did not configure it). Default value is "NS".
   Example : 'N'
