...
**[2]:** Not collected by default; can be enabled via instrumentation configuration. This attribute may contain private or sensitive information. The instrumentation library should support accepting a function that will sanitize the statement before recording it.
