...
| `code.url` | string | A valid Url that points to the code that generated the span. If the Url points to a VCS, the link SHOULD contain the file and line number references, and SHOULD point to the individual revision of the code. | `https://github.com/open-telemetry/opentelemetry-specification/blob/afc47a5a7d41b3f468d2fb3fc2ddb0c7ad52fadc/specification/trace/semantic_conventions/span-general.md#L259` | Optional |
<!-- endsemconv -->
