...
|---|---|---|---|---|
| `exception.escaped` | boolean | **Stable**<br>SHOULD be set to true if the exception event is recorded at a point where it is known that the exception is escaping the scope of the span. [1] |  | Recommended |
