...
The processor SHOULD invoke the `LogRecordExporter`'s `Export` when any of
the following happens AND the previous export call has returned:

- `scheduledDelayMillis` after the processor is constructed.
