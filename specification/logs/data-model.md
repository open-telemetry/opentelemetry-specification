...
Name           |Short low cardinality event classifier.
...
Description: Short low cardinality event classifier that does not contain
varying parts. `Name` describes what happened (e.g. "ProcessStarted").
Recommended to be no longer than 50 characters. Typically used for filtering and
grouping purposes in backends. This field is optional.
