...
for [emitting LogRecords](./spi.md#emit-logrecord) that conform
...
* `logger` - the delegate [Logger](./spi.md#logger) used to emit `Events`
  as `LogRecords`.
...
* `logRecord` - the [LogRecord](./spi.md#logrecord) representing the Event.

**Implementation Requirements:**

The implementation MUST [emit](./spi.md#emit-logrecord) the `logRecord` to
