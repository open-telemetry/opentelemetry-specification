...
The configuration options MAY be implemented directly in the OTLP exporter, in the SDK, or in a seperate component (e.g. environment-based autoconfiguration component).
