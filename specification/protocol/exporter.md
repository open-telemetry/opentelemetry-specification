...
| Client Certificate File | The certificae to configure the client's TLS credentials for use with mTLS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | n/a | `OTEL_EXPORTER_OTLP_CLIENT_PRIVATE_KEY`, `OTLP_EXPORTER_OTLP_TRACES_CLIENT_PRIVATE_KEY`, `OTLP_EXPORTER_OTLP_METRICS_CLIENT_PRIVATE_KEY` |
