...
| Compression          | Compression method used to compress HTTP(S) messages. Supported values: `gzip`, `none` | `gzip` [1]           | `OTEL_EXPORTER_OTLP_COMPRESSION` `OTEL_EXPORTER_OTLP_TRACES_COMPRESSION` `OTEL_EXPORTER_OTLP_METRICS_COMPRESSION` |
