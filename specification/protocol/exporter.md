...
| Insecure                | Whether to enable client transport security for the exporter's gRPC connection. This option only applies to OTLP/gRPC - OTLP/HTTP always uses the scheme provided for the `endpoint`. Implementations MAY choose to not implement the `insecure` option if it is not required or supported by the underlying gRPC client implementation.                                                                                                                                                                                                                                                                                                                                 | `false` | `OTEL_EXPORTER_OTLP_INSECURE` `OTEL_EXPORTER_OTLP_TRACES_INSECURE` `OTEL_EXPORTER_OTLP_METRICS_INSECURE` `OTEL_EXPORTER_OTLP_SPAN_INSECURE` `OTEL_EXPORTER_OTLP_METRIC_INSECURE` [2] |
...
| Client Private Key File | The private key to configure the client's TLS credentials for use with mTLS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | n/a | `OTEL_EXPORTER_OTLP_CLIENT_PRIVATE_KEY`, `OTLP_EXPORTER_OTLP_TRACES_CLIENT_PRIVATE_KEY`, `OTLP_EXPORTER_OTLP_METRICS_CLIENT_PRIVATE_KEY`                                             |
| Client Certificate File | The certificate to configure the client's TLS credentials for use with mTLS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | n/a | `OTEL_EXPORTER_OTLP_CLIENT_CERTIFICATE`, `OTLP_EXPORTER_OTLP_TRACES_CLIENT_CERTIFICATE`, `OTLP_EXPORTER_OTLP_METRICS_CLIENT_CERTIFICATE`                                             |
...
| Protocol                | The transport protocol. Options MAY include `grpc`, `http/protobuf`, and `http/json`. See [Specify Protocol](./exporter.md#specify-protocol) for more details.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `http/protobuf` [3]        | `OTEL_EXPORTER_OTLP_PROTOCOL` `OTEL_EXPORTER_OTLP_TRACES_PROTOCOL` `OTEL_EXPORTER_OTLP_METRICS_PROTOCOL`                                                                             |
