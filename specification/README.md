...
- The official acronym used by the OpenTelemetry project is "OTel". Refrain from
  ...
  project.
- The official names for individual implementations follow the pattern of
  "OpenTelemetry {the name of the programming language or runtime}", for
  example, "OpenTelemetry Python" and "OpenTelemetry .NET".
