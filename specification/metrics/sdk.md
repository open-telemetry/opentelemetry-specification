...
The `MetricReader` is not required to ensure data points from an
[asynchronous bridge callback](./api.md#asynchronous-bridge-callback) are
output in the configured aggregation temporality, as these data points are not
collected using OpenTelemetry instruments.
...
[asynchronous SDK Instruments](./api.md#asynchronous-instrument-api) or
[asynchronous bridge callbacks](./api.md#asynchronous-bridge-callback)
