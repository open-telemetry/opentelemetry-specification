...
|---|---|---|---|---|
| `type` | string | **Stable**<br>The type of memory. | `heap`; `non_heap` | Recommended |
| `pool` | string | **Stable**<br>Name of the memory pool. [1] | `G1 Old Gen`; `G1 Eden space`; `G1 Survivor Space` | Recommended |
...
| Attribute  | Type | Description  | Examples  | Requirement Level |
|---|---|---|---|---|
| `gc` | string | **Stable**<br>Name of the garbage collector. [1] | `G1 Young Generation`; `G1 Old Generation` | Recommended |
| `action` | string | **Stable**<br>Name of the garbage collector action. [2] | `end of minor GC`; `end of major GC` | Recommended |
...
| Attribute  | Type | Description  | Examples  | Requirement Level |
|---|---|---|---|---|
| `daemon` | boolean | **Stable**<br>Whether the thread is daemon or not. |  | Recommended |
<!-- endsemconv -->
...
| Attribute  | Type | Description  | Examples  | Requirement Level |
|---|---|---|---|---|
| `pool` | string | **Stable**<br>Name of the buffer pool. [1] | `mapped`; `direct` | Recommended |
