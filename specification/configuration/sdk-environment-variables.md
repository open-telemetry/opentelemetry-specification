...
Refer to the Trace SDK [Batching processor specification](https://opentelemetry.io/docs/specs/otel/trace/sdk/#batching-processor) for more information on these configuration parameters.
...
Refer to the Logs SDK [Batching processor specification](https://opentelemetry.io/docs/specs/otel/logs/sdk/#batching-processor) for more information on these configuration parameters.
