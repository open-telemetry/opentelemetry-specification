...
| OTEL_ENTITIES                      | Entity information to be associated with the resource. **Status**: [Development](../document-status.md)                                                     |                                                                                                                                                                                                    | [String][]   | Only parsed when `OTEL_EXPERIMENTAL_ENTITIES_ENABLED` is `true`. See [Entity Configuration](#entity-configuration) for more details.                                                                                                                                                     |
| OTEL_EXPERIMENTAL_ENTITIES_ENABLED | Enables experimental entity support in the SDK. **Status**: [Development](../document-status.md)                                                            | false                                                                                                                                                                                              | [Boolean][]  | When `true`, enables parsing of `OTEL_ENTITIES` and causes resource detectors to operate in entity-aware mode. See [Entity Configuration](#entity-configuration) for more details.                                                                                                       |
...
When `OTEL_EXPERIMENTAL_ENTITIES_ENABLED` is `true`, the SDK enables
experimental entity support with two effects:

1. The SDK parses `OTEL_ENTITIES` to discover entity information and associates
   it with the resource as describe in [entity propagation](../entities/entity-propagation.md).
2. Resource detectors operate in entity-aware mode, producing resources with
   structured entity information attached rather than simple flat collections of
   attribute key-value pairs.
   See [Entity-aware resource detectors](../resource/sdk.md#entity-aware-resource-detectors)
   for more details.
