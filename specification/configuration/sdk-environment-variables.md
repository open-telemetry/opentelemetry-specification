...
| OTEL_EXPERIMENTAL_ENTITIES_ENABLED | Enables experimental entity support in the SDK. **Status**: [Development](../document-status.md)                                                            | false                                                                                                                                                                                              | [Boolean][]  | When `true`, preserves entity information on detected resources and enables parsing of `OTEL_ENTITIES`. See [Entity Configuration](#entity-configuration) for more details.                                                                                                       |
...
When `OTEL_EXPERIMENTAL_ENTITIES_ENABLED` is `true`, the SDK preserves entity
information on detected resources (see [Entity-aware resource detectors](../resource/sdk.md#entity-aware-resource-detectors))
and additionally parses `OTEL_ENTITIES` via the
[EnvEntityDetector](../entities/entity-propagation.md#enventitydetector).
