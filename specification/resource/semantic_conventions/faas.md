...
| `faas.max_memory` | number | The amount of memory available to the serverless function in MiB. [2] | `128` | Conditional [3] |
...
**[2]:** On AWS Lambda, the environment variable `AWS_LAMBDA_FUNCTION_MEMORY_SIZE` provides this information.

**[3]:** Required for executions on serverless environments given that the respective environment provides this information.
<!-- endsemconv -->
