...
- [OTEP-006](https://github.com/open-telemetry/oteps/blob/master/text/0006-sampling.md) Move sampling from the API tp the SDK.
- [OTEP-0007](https://github.com/open-telemetry/oteps/blob/master/text/0007-no-out-of-band-reporting.md) Move support for out-of-band telemetry from the API to the SDK.
- [OTEP-0016](https://github.com/open-telemetry/oteps/blob/master/text/0016-named-tracers.md) Add named providers for Tracers and Meters.
