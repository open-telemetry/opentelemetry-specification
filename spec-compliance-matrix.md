...
| SpanKind mapping                                      |          | +  | + | +  | +                                                                       | +    | +      | +   | +    |     | +    | +     |
| InstrumentationLibrary mapping                        |          | [-](https://github.com/open-telemetry/opentelemetry-go/pull/1688) | + | -  | +                                                                       | +    | -      | -   | +    |     | +    | +     |
| Boolean attributes                                    |          | +  | + | +  | +                                                                       | +    | +      | +   | +    |     | +    | +     |
| Array attributes                                      |          | [-](https://github.com/open-telemetry/opentelemetry-go/pull/1688) | + | +  | [-](https://github.com/open-telemetry/opentelemetry-python/issues/1110) | +    | +      | +   | +    |     | +    | +     |
| Status mapping                                        |          | [-](https://github.com/open-telemetry/opentelemetry-go/pull/1688) | + | +  | +                                                                       | +    | +      | +   | +    |     | +    | +     |
| Error Status mapping                                  |          | [-](https://github.com/open-telemetry/opentelemetry-go/pull/1688) | + |    |                                                                         | +    |        |     |      |     | +    | -     |
