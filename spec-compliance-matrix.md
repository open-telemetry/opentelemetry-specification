...
| The `add` method return no (or dummy) value.                                                                                                                                 |  X       |    |  +   |    |        |      |        |     |      |     |   +  |       |
...
| `create_up_down_counter` returns an `UpDownCounter` object.                                                                                                                  |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `UpDownCounter` accepts the name of the instrument.                                                                                                              |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `UpDownCounter` accepts the unit of the instrument.                                                                                                              |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `UpDownCounter` accepts the description of the instrument.                                                                                                       |          |    |      |    |        |      |        |     |      |     |      |       |
| `UpDownCounter` has an `add` method.                                                                                                                                         |          |    |      |    |        |      |        |     |      |     |      |       |
| The `add` method return no (or dummy) value.                                                                                                                                 |  X       |    |      |    |        |      |        |     |      |     |      |       |
| The `add` method accepts optional attributes.                                                                                                                                |          |    |      |    |        |      |        |     |      |     |      |       |
| The `add` method accepts the increment amount.                                                                                                                               |          |    |      |    |        |      |        |     |      |     |      |       |
| `create_asynchronous_up_down_counter` creates an `AsynchronousUpDownCounter`.                                                                                                |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `AsynchronousUpDownCounter` accepts the name of the instrument.                                                                                                  |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `AsynchronousUpDownCounter` accepts the unit of the instrument.                                                                                                  |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `AsynchronousUpDownCounter` accepts the description of the instrument.                                                                                           |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `AsynchronousUpDownCounter` accepts a callback.                                                                                                                  |          |    |      |    |        |      |        |     |      |     |      |       |                                                                                                                               | X        |    |  +   |    |        |      |        |     |      |     |   +  |       |
| `create_histogram` returns a `Histogram` object.                                                                                                                             |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `Histogram` accepts the name of the instrument.                                                                                                                  |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `Histogram` accepts the unit of the instrument.                                                                                                                  |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `Histogram` accepts the description of the instrument.                                                                                                           |          |    |      |    |        |      |        |     |      |     |      |       |
...
| `create_asynchronous_gauge` creates an `AsynchronousGauge`.                                                                                                                  |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `AsynchronousGauge` accepts the name of the instrument.                                                                                                          |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `AsynchronousGauge` accepts the unit of the instrument.                                                                                                          |          |    |      |    |        |      |        |     |      |     |      |       |
| The API for `AsynchronousGauge` accepts the description of the instrument.                                                                                                   |          |    |      |    |        |      |        |     |      |     |      |       |
...
| The `View` allows configuring description, attributes keys, aggregation and (optional) exemplar reservoir of resulting metric stream.                                        |          |    |  ?   |    |        |      |        |     |      |     |   -  |       |
| The SDK allows more the one `View` to be specified per instrument.                                                                                                           | X        |    |  ?   |    |        |      |        |     |      |     |   +  |       |
| The `None` aggregation is available.                                                                                                                                         |          |    |  +   |    |        |      |        |     |      |     |   +  |       |
| The `None` aggregation drops all measurements and does not return a metric stream.                                                                                           |          |    |  +   |    |        |      |        |     |      |     |   +  |       |
...
| The metrics exporter has access to the pre aggregated metrics data (aggregated points, not raw measurements).                                                                |          |    |  -   |    |        |      |        |     |      |     |   +  |       |
