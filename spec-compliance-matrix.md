...
| The metrics Reader supports a per-instrumentation library timeseries limit                                                                                             |          |    |      |    |        |      |        |     |      |     |      |       |
| The metrics Reader supports a per-instrumentation library, per instrument timeseries limit                                                                             |          |    |      |    |        |      |        |     |      |     |      |       |
