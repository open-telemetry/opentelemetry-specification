...
- [Data Model](#data-model)
  ...
  * [Message Descriptions](#message-descriptions)
    ...
    + [Message `ResourceProfiles`](#message-resourceprofiles)
      ...
      - [Field `scope_profiles`](#field-scope_profiles)
      - [Field `schema_url`](#field-schema_url)
    + [Message `ScopeProfiles`](#message-scopeprofiles)
      - [Field `scope`](#field-scope)
      - [Field `profiles`](#field-profiles)
      - [Field `schema_url`](#field-schema_url-1)
    + [Message `ProfileContainer`](#message-profilecontainer)
      - [Field `profile_id`](#field-profile_id)
      - [Field `start_time_unix_nano`](#field-start_time_unix_nano)
      - [Field `end_time_unix_nano`](#field-end_time_unix_nano)
      - [Field `attributes`](#field-attributes)
      - [Field `dropped_attributes_count`](#field-dropped_attributes_count)
      - [Field `original_payload_format`](#field-original_payload_format)
      - [Field `original_payload`](#field-original_payload)
    ...
    + [Message `Profile`](#message-profile)
      ...
      - [Field `location_indices`](#field-location_indices)
      - [Field `function`](#field-function)
      - [Field `attribute_table`](#field-attribute_table)
      - [Field `attribute_units`](#field-attribute_units)
      - [Field `link_table`](#field-link_table)
      - [Field `string_table`](#field-string_table)
      - [Field `drop_frames`](#field-drop_frames)
      - [Field `keep_frames`](#field-keep_frames)
      - [Field `time_nanos`](#field-time_nanos)
      - [Field `duration_nanos`](#field-duration_nanos)
      - [Field `period_type`](#field-period_type)
      - [Field `period`](#field-period)
      - [Field `comment`](#field-comment)
      - [Field `default_sample_type`](#field-default_sample_type)
    + [Message `ValueType`](#message-valuetype)
      - [Field `unit`](#field-unit)
      - [Field `aggregation_temporality`](#field-aggregation_temporality)
    + [Message `Sample`](#message-sample)
      - [Field `location_index`](#field-location_index)
      - [Field `locations_start_index`](#field-locations_start_index)
      - [Field `locations_length`](#field-locations_length)
      - [Field `stacktrace_id_index`](#field-stacktrace_id_index)
      - [Field `value`](#field-value)
      - [Field `label`](#field-label)
      - [Field `attributes`](#field-attributes-1)
      - [Field `link`](#field-link)
      - [Field `timestamps`](#field-timestamps)
    + [Message `AttributeUnit`](#message-attributeunit)
      - [Field `attribute_key`](#field-attribute_key)
      - [Field `unit`](#field-unit-1)
    + [Message `Link`](#message-link)
      - [Field `trace_id`](#field-trace_id)
      - [Field `span_id`](#field-span_id)
    + [Message `Location`](#message-location)
      - [Field `id`](#field-id)
      - [Field `mapping_index`](#field-mapping_index)
      - [Field `address`](#field-address)
      - [Field `line`](#field-line)
      - [Field `is_folded`](#field-is_folded)
      - [Field `type_index`](#field-type_index)
      - [Field `attributes`](#field-attributes-2)
    + [Message `Line`](#message-line)
      - [Field `function_index`](#field-function_index)
      - [Field `line`](#field-line-1)
      - [Field `column`](#field-column)
    + [Message `Mapping`](#message-mapping)
      - [Field `id`](#field-id-1)
      - [Field `memory_start`](#field-memory_start)
      - [Field `memory_limit`](#field-memory_limit)
      - [Field `file_offset`](#field-file_offset)
      - [Field `filename`](#field-filename)
      - [Field `build_id`](#field-build_id)
      - [Field `build_id_kind`](#field-build_id_kind)
      - [Field `attributes`](#field-attributes-3)
      - [Field `has_functions`](#field-has_functions)
    + [Message `Function`](#message-function)
      - [Field `id`](#field-id-2)
      - [Field `name`](#field-name)
      - [Field `system_name`](#field-system_name)
      - [Field `filename`](#field-filename-1)
      - [Field `start_line`](#field-start_line)
